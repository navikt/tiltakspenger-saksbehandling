        ...
        >
          ...
          <div style={{ width: '62%' }}>
            <Select
              ...
              onChange={(e) => oppdaterMeldekort(index, e.target.value)}
            >
              <option value={MeldekortStatus.DELTATT}>
                Deltatt i tiltaket
              </option>
              <option value={MeldekortStatus.IKKE_DELTATT}>
                Ikke deltatt i tiltaket
              </option>
              <option value={MeldekortStatus.LØNN_FOR_TID_I_ARBEID}>
                Lønn for tid i arbeid
              </option>
              <option value={MeldekortStatus.FRAVÆR_SYK}>Fravær syk</option>
              <option value={MeldekortStatus.FRAVÆR_SYKT_BARN}>
                Fravær sykt barn
              </option>
              <option value={MeldekortStatus.FRAVÆR_VELFERD}>
                Fravær velferd
              </option>
            </Select>
          </div>
