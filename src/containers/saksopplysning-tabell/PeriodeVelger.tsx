import {ErrorMessage, DatePicker, useDatepicker, HStack} from '@navikt/ds-react';
...
export default function Periodevelger({
    ...
    const fromDatePicker = useDatepicker({
        ...
        onValidate: (validation) => {
            if (validation.isBefore || validation.isAfter) {
                setRangeError({ from: 'Fra-dato kan ikke være utenfor behandlingsperioden' });
            } else {
    ...
    const toDatePicker = useDatepicker({
        ...
        onValidate: (validation) => {
            if (validation.isBefore || validation.isAfter) {
                setRangeError({ to: 'Til-dato kan ikke være utenfor behandlingsperioden' });
            } else {
