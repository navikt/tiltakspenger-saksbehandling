...
import { RevurderingStansVedtak } from '~/lib/behandling/revurdering/stans/RevurderingStansVedtak';
import { RevurderingInnvilgelseVedtak } from '~/lib/behandling/revurdering/innvilgelse/RevurderingInnvilgelseVedtak';
