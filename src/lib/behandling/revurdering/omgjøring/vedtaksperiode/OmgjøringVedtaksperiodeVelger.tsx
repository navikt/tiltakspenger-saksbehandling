...
import { VedtaksperiodevelgerGjeldendePerioder } from '~/lib/behandling/revurdering/omgjøring/vedtaksperiode/gjeldende-perioder/VedtaksperiodevelgerGjeldendePerioder';
