...
import { StansOgOpphørHjemmelVelger } from '~/lib/behandling/revurdering/felles/hjemmel-velger/StansOgOpphørHjemmelVelger';
...
const aktuelleHjemler: HjemmelForStans[] = Object.values(HjemmelForStans);
