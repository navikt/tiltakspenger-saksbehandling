...
import { BehandlingAvslutt } from '~/lib/behandling/felles/send-og-godkjenn/avslutt/BehandlingAvslutt';
import { BehandlingSendTilBeslutning } from '~/lib/behandling/felles/send-og-godkjenn/send-til-beslutning/BehandlingSendTilBeslutning';
import { BehandlingGodkjenn } from '~/lib/behandling/felles/send-og-godkjenn/godkjenn/BehandlingGodkjenn';
import { BehandlingLagreKnapp } from '~/lib/behandling/felles/send-og-godkjenn/lagre/BehandlingLagreKnapp';
import { ValideringResultat } from '~/types/Validering';
import React, { useState } from 'react';
import { BehandlingValideringVarsler } from '~/lib/behandling/felles/send-og-godkjenn/varsler/BehandlingValideringVarsler';
import {
    BehandlingLagringResultat,
    BehandlingLagringVarsler,
} from '~/lib/behandling/felles/send-og-godkjenn/varsler/BehandlingLagringVarsler';
import { BehandlingLagringProps } from '~/lib/behandling/felles/send-og-godkjenn/lagre/useHentBehandlingLagringProps';
import { SaksbehandlerRolle } from '~/types/Saksbehandler';
import { BehandlingSettPåVent } from '~/lib/behandling/felles/send-og-godkjenn/sett-på-vent/BehandlingSettPåVent';
import { BehandlingGjenoppta } from '~/lib/behandling/felles/send-og-godkjenn/gjenoppta/BehandlingGjenoppta';
import {
    erSattPaVent,
