...
import { erRammebehandlingUnderAktivOmgjøring } from '../../rammebehandling/rammebehandlingUtils';
import { KlagehendelseUtfall } from '~/lib/klage/typer/Klageinstanshendelse';
import {
