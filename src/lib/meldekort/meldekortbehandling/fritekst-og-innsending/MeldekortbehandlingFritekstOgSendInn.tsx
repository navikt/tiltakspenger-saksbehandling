...
import { MeldekortbehandlingKorrigeringUtfall } from '~/lib/meldekort/meldekortbehandling/fritekst-og-innsending/korrigering-utfall/MeldekortbehandlingKorrigeringUtfall';
