...
export enum BrukersMeldekortKjedeStatus {
    IKKE_MOTTATT = 'IKKE_MOTTATT',
    VENTER_BEHANDLING = 'VENTER_BEHANDLING',
    KORRIGERING_VENTER_BEHANDLING = 'KORRIGERING_VENTER_BEHANDLING',
    UNDER_BEHANDLING = 'UNDER_BEHANDLING',
    KORRIGERING_UNDER_BEHANDLING = 'KORRIGERING_UNDER_BEHANDLING',
    BEHANDLET = 'BEHANDLET',
    KORRIGERING_BEHANDLET = 'KORRIGERING_BEHANDLET',
    AVBRUTT = 'AVBRUTT',
    KORRIGERING_AVBRUTT = 'KORRIGERING_AVBRUTT',
}
