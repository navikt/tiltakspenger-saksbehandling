...
export enum MeldekortBehandletAutomatiskStatus {
    ...
    MÅ_BEHANDLE_FØRSTE_KJEDE = 'MÅ_BEHANDLE_FØRSTE_KJEDE',
    MÅ_BEHANDLE_NESTE_KJEDE = 'MÅ_BEHANDLE_NESTE_KJEDE',
    INGEN_DAGER_GIR_RETT = 'INGEN_DAGER_GIR_RETT',
    HAR_JUSTERING = 'HAR_JUSTERING',
    HAR_FEILUTBETALING = 'HAR_FEILUTBETALING',
}
