...
export const UtbetalingUkeDag = ({ utbetalingUke }: UtbetalingUkeProps) => {
  return (
        ...
        return (
          <div key={i} className={styles.utbetalingDagListeGrid}>
            <HGrid gap="12" columns={4}>
              <Detail truncate>{ukedagFraDate(dag.dato)}</Detail>
              <Detail truncate>{formaterDatotekst(dag.dato.toString())}</Detail>
