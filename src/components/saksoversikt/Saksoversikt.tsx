import { Box, HStack, Heading, Spacer, Button, Table, DatePicker } from '@navikt/ds-react';
...
import { dateTilISOTekst, formaterTidspunkt, periodeTilFormatertDatotekst } from '../../utils/date';
import {
    finnStatusTekst,
...
export const Saksoversikt = ({
    ...
    const { opprettRevurdering, oppretterBehandling } = useOpprettRevurdering(sakId, saksnummer);
