...
const BrukerFyller18ÅrIPeriodenMelding = ({
  periode,
}: BrukerFyller18ÅrIPeriodenMeldingProps) => {
  return (
    <Alert variant="error" style={{ marginTop: '1rem' }}>
      <span>
        <strong>
          Bruker har ikke fylt 18 år i deler av perioden det er søkt
          tiltakspenger for:
        </strong>
        <ul style={{ marginTop: '0.5rem', marginBottom: '0' }}>
          <li>
            {periode.til
              ? formatPeriode(periode as Periode)
              : formatÅpenPeriode(periode as ÅpenPeriode)}
          </li>
        </ul>
      </span>
    </Alert>
