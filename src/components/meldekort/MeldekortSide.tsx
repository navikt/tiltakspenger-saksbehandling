...
export const MeldekortSide = () => {
    ...
    //kan være undefined bruker enda ikke har sendt inn meldekort, og saksbehandler oppretter meldekortbehandling uten meldekort
    ...
    console.log(sisteInnsendteMeldekort, sisteMeldekortBehandling);
