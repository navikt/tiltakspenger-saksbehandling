      ...
      >
        <VStack gap="4">
          {oppdaterTilleggstekstError?.message && (
            <Varsel
              variant={'error'}
              melding={oppdaterTilleggstekstError.message}
            />
          )}
          <BodyLong>
            Legg til begrunnelse for endringene som er gjort i behandlingen.
            Denne begrunnelsen vil legges til i fritekstfeltet i vedtaksbrevet.
          </BodyLong>
          <Controller
            control={control}
            name="subsumsjon"
