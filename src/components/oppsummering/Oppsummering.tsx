...
const Oppsummering = () => {
    ...
    const retur = valgtBehandling.attesteringer.findLast((attestering) => attestering.begrunnelse);

    const visBegrunnelse = valgtBehandling.status === BehandlingStatus.UNDER_BEHANDLING && retur;
