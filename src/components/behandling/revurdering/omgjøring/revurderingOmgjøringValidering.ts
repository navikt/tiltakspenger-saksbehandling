...
import { perioderOverlapper, periodiseringTotalPeriode } from '~/utils/periode';
...
export const revurderingOmgjøringValidering = (
    ...
    } else if (skjema.innvilgelse.harValgtPeriode) {
        const totalInnvilgelsesperiode = periodiseringTotalPeriode(
