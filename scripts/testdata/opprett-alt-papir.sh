...
output="$("${SCRIPT_DIR}/opprett-innvilget-sak-papir.sh")"
saksnummer=""
sak_id=""
behandling_id=""
...
[[ -n "$saksnummer" ]] || fail "Mangler saksnummer fra opprett-innvilget-sak-papir.sh."
[[ -n "$sak_id" ]] || fail "Mangler sakId fra opprett-innvilget-sak-papir.sh."
[[ -n "$behandling_id" ]] || fail "Mangler behandlingId fra opprett-innvilget-sak-papir.sh."
